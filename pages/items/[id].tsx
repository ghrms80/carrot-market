    ...
    <Layout canGoBack>
      <div className="px-4 py-10">
        <div className="mb-8">
          ...
          <div className="mt-1 flex cursor-pointer items-center space-x-3 border-t border-b py-3">
          ...
          <div className="mt-5">
            ...
            <p className="mt-3 block text-3xl text-gray-900">$140</p>
            ...
            <div className="flex items-center justify-between space-x-2">
              {/* <button
                className="flex-1 rounded-md bg-orange-500 py-3 font-medium text-white 
